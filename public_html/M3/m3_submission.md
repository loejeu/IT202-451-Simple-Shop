...
<tr><td> <em>Generated: </em> 6/11/2023 10:34:46 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-451-M23/it202-javascript-and-css-challenge/grade/jl2334" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fjl2334%2F2023-06-11T21.36.21image.png.webp?alt=media&token=aea856a5-38d3-4ce7-9d4a-4c58efa2c357"/></td></tr>
<tr><td> <em>Caption:</em> <p>Screenshot of checklist items completed from <style> tag<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>The navigation can be made horizontal by setting the display to block elements<br>and then making &lt;li&gt; tags float to the left.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>The navigation list item markers can be removed by setting the list-style-type property<br>to none to replace with checkmarks.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>I gave the navigation a background by adding background-color to the &lt;ul&gt; tag.<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>To change the color I gave the &lt;a&gt; tag hover whenever is it<br>a descendant of the &lt;li&gt; tag.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>By setting the list-style-type property to \2713 to replace with checkmarks under the<br>&lt;ul&gt; tag.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>I gave both the h1 and anchor tags a capitalize text-transform property to<br>always capitalize the first letter in every word.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>The styling of my choice was to add borders for Login, Register, Profile,<br>and Logout. It gives the user an easier time when traversing the site<br>and can easily point out if they were separated.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>By giving each tag your own unique name you can decide which tags<br>get the style you want.<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned how to style a page using CSS and JavaScript. There are<br>many different ways in designing a page and utilizing tags to go along<br>with your code.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Add a link to your pull request (hw branch to dev only)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/loejeu/IT202-451/pull/9">https://github.com/loejeu/IT202-451/pull/9</a> </td></tr>
<tr><td> <em>Sub-Task 3: </em> Add a link to your solution html file from prod (again you can assume the url at this point)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://jl2334-prod.herokuapp.com/M3/problem1.html">https://jl2334-prod.herokuapp.com/M3/problem1.html</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-451-M23/it202-javascript-and-css-challenge/grade/jl2334" target="_blank">Grading</a></td></tr></table>